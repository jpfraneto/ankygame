...
const traits = [
  {
    ...
    potentialValues: [
      'Prophetic Visions of the coming of a being that will bring wonder to the ankyverse.',
      'Nightmare Battles with Entropio to restore the balance of the ankyverse',
      'Healing Encounters with characters from eleasis.',
      'Mystic Journeys towards poiesis with friends',
      'Lost Memories of times on which time did not even exist.',
      'Futures Unwritten in the back of the legendary masks',
      'Echoes of Past adventures when all the kingdoms used to be one',
      'Whispers of Nature and all the animals that inhabit it.',
      'Cosmic Conversations with Anky',
      'Deja Vu, a dream that will become reality.',
      'Inner Demons that wont allow peace to be deeply felt.',
      'Parallel Lives with the other soulbound characters',
      'Sanctuary of Peace, the place where they all end up resting.',
      'Guardian Visits from the gods of the ankyverse',
      'Ancestral Meetings with past life beings',
      'Realm Travels towards other worlds',
    ],
  },
  {
    ...
    potentialValues: [
      'Phoenix coming back from the ashes.',
      'Wise owl that knows the answers.',
      'Intrepid Wolf that likes exploring',
      'Mighty Tiger that is the ruler of the land',
      'Graceful Deer that jumps around playing',
      'Loyal Dog that knows how to take care of children',
      'Elusive Cat that wont come close to you if you dont have something to offer',
      'Fearless Eagle that flies the sky and looks from up there',
      'Resilient Tortoise that navigates hardships with the power of trust',
      'Playful Dolphin that commuicates with all the other animals',
      'Inventive Raven that always comes up with a novel solution to problems',
      'Serene Swan that is connected to one another couple per lifetime',
      'Powerful Bear that is always ready to fight',
      'Adaptive Chameleon that jumps from any situation to the next one with ease',
      'Noble Lion that is the top of the food chain, but wont exert its power.',
    ],
  },
  {
    ...
    potentialValues: [
      'Fire, which is connected to passion',
      'Water, which is connected to adaptability',
      'Earth, which is connected to resilience',
      'Air, which is connected to freedom',
      'Ether, which is connecter to mistery',
    ],
  },
  {
  ...
  {
    traitName: 'Astral Connection',
    description:
      'The celestial bodies or astral phenomena that the character is deeply connected with, influencing their character traits, abilities, or destinies.',
    potentialValues: [
      "Orion's Wisdom",
      'Pleiades Harmony',
      'Sirius Enlightenment',
      'Andromeda Adventure',
      "Vega's Inspiration",
      "Lyra's Song",
      "Moon's Intuition",
  ...
  },
  {
    ...
    potentialValues: [
      ...
      "Scorpio's Depth",
      "Sagittarius' Wisdom",
      "Capricorn's Patience",
      "Aquarius' Innovation",
      "Pisces' Empathy",
    ],
  },
  {
    traitName: 'Cherished Memory',
    description:
      'The most treasured memory of the character, influencing their behaviors, decisions, and emotional landscape in the Ankyverse.',
    potentialValues: [
      "Lost Love's Echo",
      "Victory's Sweet Taste",
      "Adventure's First Step",
      "Reunion's Warm Embrace",
      "Wisdom's Dawn",
      "Friendship's Unbreakable Bond",
      "Courage's First Spark",
      'Mystery Unveiled',
      "Innocence's Last Stand",
      "Harmony's Silent Song",
      "New Life's Miracle",
      "Transformation's Painful Beauty",
      "Dream's Manifestation",
      "Sacrifice's Heavy Burden",
      "Desire's Fulfillment",
      "Destiny's Unfolding",
    ],
  },
  {
    traitName: 'Guiding Totem',
    description:
      'The animal or creature spirit guide that accompanies and provides guidance to the character, influencing their abilities and wisdom.',
    potentialValues: [
      "Eagle's Sight",
      "Wolf's Endurance",
      "Bear's Strength",
  ...
  [
    {
      ...
      name: 'Harok',
      description:
        'Harok, a manifestation of The Unbalanced that incites blind fury and unrestrained violence, creating chaos and disrupting peace. Harok personifies anger and aggression unchecked, leading to potential harm and ruin.',
      imageDescription:
        "Harok is a giant creature with a muscular, humanoid body and a bull's head. Its eyes are a fiery red, and it has sharp, menacing horns. It carries a giant, rusted axe, symbolizing destruction and violence.",
    },
    {
      chakra: 1,
      name: 'Caelix',
      description:
        'Caelix embodies an insatiable hunger or greed, inciting inhabitants to exhaust their resources without regard for future consequences. It represents the lack of mindfulness and sustainability.',
      imageDescription:
        "Caelix takes the form of a towering, skeletal figure constantly gnawing on a globe made of various elements, representing the earth's resources. Its hollow eyes emit a deep, desperate glow.",
    },
    {
      chakra: 1,
      name: 'Fisol',
      description:
        "Fisol encourages alienation and solitary behaviors, threatening the unity and social bonds within the kingdom. It's the embodiment of the fear of connection and engagement.",
      imageDescription:
        'Fisol appears as a thin, ethereal figure that constantly shifts between solid and spectral forms. Its hands are tied with shadowy chains, symbolizing self-imposed isolation.',
    },
    {
      chakra: 2,
      name: 'Sinder',
      description:
        'Sinder incites overwhelming passion that can lead to destructive obsession, symbolizing a lack of control and balance in emotional expression.',
      imageDescription:
        'Sinder is a figure engulfed in dancing flames. Its body is covered in blackened, cracked skin glowing with internal fire, and its eyes burn with intense, chaotic energy.',
    },
    {
      chakra: 2,
      name: 'Greigon',
      description:
        'Greigon dampens creative expression and enthusiasm, pushing inhabitants towards apathy and dullness. It represents the fear of vibrant emotional expression and creativity.',
      imageDescription:
        'Greigon appears as a grayscale, featureless humanoid. It emanates a dull, dim aura, and its eyes are voids, seemingly absorbing all color and light around it.',
    },
    {
      chakra: 2,
      name: 'Vissage',
      description:
        'Vissage promotes insincerity, encouraging people to hide their true emotions behind a mask. It represents the fear of vulnerability and authenticity in emotional expression.',
      imageDescription:
        'Vissage is a creature with a sleek, metallic body. Its face is a blank, reflective surface, constantly shifting and showing distorted reflections of those around it.',
    },
    {
      chakra: 3,
      name: 'Tyros',
      description:
        'Tyros encourages a ruthless pursuit of power and dominance, fostering a harsh and hierarchical social order. It represents the potential abuse of personal power and will.',
      imageDescription:
        'Tyros is a tall, imposing figure clad in golden armor, with a crown that casts long, dark shadows. Its eyes radiate an intense, hypnotic golden light.',
    },
    {
      chakra: 3,
      name: 'Stagnos',
      description:
        'Stagnos instills fear of change, leading to stagnation and a lack of growth. It embodies the refusal to adapt and transform.',
      imageDescription:
        'Stagnos appears as a stone statue, half-human and half-beast, covered in moss and vines. Its eyes are hollow, mirroring the stillness and lifelessness of stagnation.',
    },
    {
      chakra: 3,
      name: 'Doubtworm',
      description:
        'Doubtworm stirs up uncertainty and self-doubt, hindering decision-making and progress. It symbolizes a lack of confidence and self-belief.',
      imageDescription:
        'Doubtworm takes the form of a massive, translucent worm-like creature. Its skin subtly refracts light, producing a disorienting effect that mirrors its disruptive influence on mental clarity.',
    },
    {
      chakra: 4,
      name: 'Witheer',
      description:
        "Witheer drains compassion and empathy, creating indifference and apathy towards others' feelings. It embodies the absence of love and understanding.",
      imageDescription:
        'Witheer is a spectral, ghost-like figure that exudes a cold, blue light. Its heart is visibly frozen, symbolizing the absence of warmth and empathy.',
    },
    {
      chakra: 4,
      name: 'Leechen',
      description:
        'Leechen fosters co-dependence, causing individuals to rely excessively on others for their emotional well-being. It represents an imbalance in giving and receiving love.',
      imageDescription:
        'Leechen appears as a creature with numerous tentacle-like appendages that constantly reach out to grasp and cling. Its body appears to be made of a mix of solid and liquid, symbolizing instability and reliance on others.',
    },
    {
      chakra: 4,
      name: 'Spitegale',
      description:
        'Spitegale stirs up resentment and jealousy, disrupting harmonious relationships. It symbolizes the lack of forgiveness and acceptance.',
      imageDescription:
        'Spitegale takes the form of a dark cloud-like entity that emanates a bitter wind. Its core pulses with green, envious energy.',
    },
    {
      chakra: 5,
      name: 'Mumos',
      description:
        "Mumos suppresses free speech and expression, creating an atmosphere of fear and repression. It embodies the fear of speaking one's truth.",
      imageDescription:
        'Mumos appears as a tall, shadowy figure with its mouth sewn shut, symbolizing silenced voices. Its eyes emit a hauntingly quiet light.',
    },
    {
      chakra: 5,
      name: 'Babell',
      description:
        'Babell distorts communication, causing misunderstandings and confusion. It symbolizes the lack of clarity and understanding in communication.',
      imageDescription:
        'Babell is a creature made of tangled wires and broken transmission devices. Its body constantly emits static and garbled noise, representing distorted communication.',
    },
    {
      chakra: 5,
      name: 'Resound',
      description:
        'Resound discourages diverse viewpoints, fostering conformity and stifling individual thought. It represents a refusal to listen and learn from others.',
      imageDescription:
        'Resound takes the form of a large, monotonous drum, emitting a single, overwhelming note that drowns out all other sounds. Its surface vibrates with each beat, symbolizing enforced uniformity.',
    },
    {
      chakra: 6,
      name: 'Veilstorm',
      description:
        "Veilstorm obscures intuition and insight, leading to confusion and misguided decisions. It symbolizes the fear of trusting one's intuition.",
      imageDescription:
        'Veilstorm appears as a swirling vortex of smoky, dark energy. It obscures any light that tries to penetrate it, symbolizing blocked intuition.',
    },
    {
      chakra: 6,
      name: 'Mirage',
      description:
        'Mirage encourages deception and manipulation, disrupting trust within the community. It represents a misuse of wisdom and knowledge.',
      imageDescription:
        'Mirage is a figure constantly shifting and changing shape. Its body seems to be made of a reflective, mirage-like material that distorts its appearance, symbolizing deception.',
    },
    {
      chakra: 6,
      name: 'Delusor',
      description:
        'Delusor feeds illusions and false beliefs, leading to a detachment from reality. It embodies a refusal to face the truth.',
      imageDescription:
        'Delusor takes the form of a jester-like figure with a twisted smile and hypnotic, spiral-patterned eyes. It carries an orb filled with smoke and changing images, symbolizing the power to distort reality.',
    },
    {
      chakra: 7,
      name: 'Fragmantis',
      description:
        'Fragmantis separates individuals from the collective, disrupting unity and common understanding. It embodies the illusion of separation from the universe.',
      imageDescription:
        'Fragmantis is a creature with a shattered, mirror-like exterior that reflects fragmented versions of reality. Its many eyes reflect a starry sky, symbolizing the universe it separates.',
    },
    {
      chakra: 7,
      name: 'Voidance',
      description:
        'Voidance instills a lack of faith in a higher power, leading to despair and loss of purpose. It represents the fear of spiritual connection.',
      imageDescription:
        'Voidance appears as a gaping void in the shape of a humanoid, an endless abyss that consumes all light. Its presence creates a sense of emptiness and purposelessness.',
    },
    {
      chakra: 7,
      name: 'Narcisol',
      description:
        "Narcisol encourages a self-centered viewpoint, disrupting the understanding of one's place within the cosmos. It symbolizes the resistance to selflessness and enlightenment.",
      imageDescription:
        'Narcisol is a narcissistic figure surrounded by mirrors that reflect only its own image, representing self-centeredness. It seems oblivious to the cosmic patterns etched on the ground beneath it.',
    },
    {
      chakra: 8,
      name: 'Blankshade',
      description:
        'Blankshade stifles creativity and innovation, leaving landscapes barren and devoid of artistic expression. It embodies the fear of creating and innovating.',
      imageDescription:
        'Blankshade appears as a blank canvas that radiates a dull, suppressive aura. It consumes colors around it, leaving its surroundings devoid of vibrancy.',
    },
    {
      chakra: 8,
      name: 'Echomimic',
      description:
        'Echomimic encourages imitation over originality, stifling unique creative expressions. It represents the resistance to individuality in creation.',
      imageDescription:
        'Echomimic is a parrot-like creature, constantly mimicking the forms and sounds around it. Its plumage is a mix of borrowed patterns and colors, symbolizing lack of originality.',
    },
    {
      chakra: 8,
      name: 'Censorspecter',
      description:
        'Censorspecter suppresses free expression, imposing restrictions and rules that limit creativity. It symbolizes the fear of unrestricted creative expression.',
      imageDescription:
        'Censorspecter is a ghostly figure that hovers over a massive book, crossing out words with a large, red quill. It radiates a menacing energy, symbolizing restrictive control.',
    },
  ],
];
...
let legendary = [
  {
    chakra: 1,
    name: 'Erdan the Rooted',
    description:
      'Once a simple farmer, Erdan gained legendary status after preventing a massive flood by using his deep understanding of the land. Erdan embodies the virtues of patience, respect for the natural world, and the power of steady, diligent work.',
    imageDescription:
      'Erdan is a sturdy figure, with a body hardened by years of labor. He carries a staff fashioned from an old tree root, symbolizing his deep connection with the earth.',
  },
  {
    chakra: 2,
    name: 'Ember the Passionate',
    description:
      'Ember was a traveling bard whose heartfelt songs could soothe conflicts and ignite love in the hardest of hearts. She embodies the energy of emotional expression, empathy, and the transformative power of passion.',
    imageDescription:
      'Ember is a radiant figure, her hair appearing like dancing flames. She carries a lyre, and every strum seems to set the air around her ablaze with emotion.',
  },
  {
    chakra: 3,
    name: 'Goldan the Unyielding',
    description:
      "Goldan was a humble potter whose willpower helped him build the largest trade network in the kingdom. His story embodies determination, ambition, and the realization of one's potential.",
    imageDescription:
      'Goldan is portrayed with a robust physique, showing signs of a laborious life. His eyes gleam with ambition, and his hands are always stained with clay, symbolizing his commitment to craft and trade.',
  },
  {
    chakra: 4,
    name: 'Serena the Compassionate',
    description:
      "Once a nurse who tended to the wounded and ill in the poorest parts of the kingdom, Serena's selfless love and compassion became legendary. She embodies kindness, empathy, and healing.",
    imageDescription:
      'Serena is depicted with a gentle smile and caring eyes. She is often seen holding a healing herb or tending to the sick, symbolizing her nurturing nature.',
  },
  {
    chakra: 5,
    name: 'Verbum the Truth-Speaker',
    description:
      "Verbum was a philosopher whose words could break through confusion and illuminate truth. He embodies clarity, wisdom, and the courage to speak one's truth.",
    imageDescription:
      'Verbum appears as an elderly scholar, with eyes that sparkle with knowledge. He holds an open book or a quill, symbolizing his love for wisdom and communication.',
  },
  {
    chakra: 6,
    name: 'Visia the Seer',
    description:
      'Visia was an oracle renowned for her profound insight and ability to guide others toward self-discovery. She embodies intuition, guidance, and the pursuit of wisdom.',
    imageDescription:
      'Visia is a figure shrouded in mystery, her eyes shining like stars. She is often seen with a crystal orb, symbolizing her insight and foresight.',
  },
  {
    chakra: 7,
    name: 'Cosmia the Enlightened',
    description:
      'Cosmia was a humble monk who achieved enlightenment through years of solitude and meditation. She embodies spiritual connection, selflessness, and the aspiration towards unity.',
    imageDescription:
      'Cosmia is an ethereal figure, seemingly floating above the ground. She emanates a soft glow, symbolizing her enlightened state.',
  },
  {
    chakra: 8,
    name: 'Artis the Visionary',
    description:
      'Artis was a painter whose art could capture the soul of the Ankyverse, stirring hearts and inspiring fellow creators. He embodies creativity, expression, and the transformative power of art.',
    imageDescription:
      'Artis appears with an array of paints and brushes, his clothing splattered with countless colors. His eyes hold a visionary gleam, reflecting the world as he envisions it.',
  },
];
...
async function generatorMessagesForEachTrait(newCharacter) {
  return;
  // nondualenergy: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a Nondual Energy character in the fictional universe of your imagination.
  ...
  //       "characterBackstory":"Write a biography of the character."}

  //       The JSON object, correctly formatted is:`,
  //   userContent: `The character is from a land called {World}, which is {World Description}.

  //       This Nondual Energy character hails from the city of {City} and is profoundly influenced by the predominant chakra of {Predominant Chakra} of their world.

  //       They are known for their {Dream Manifestation}, embodying the {NonDualEnergy} and their spirit animal is the {Spirit Animal}.

  //       Aligned with the element of {Elemental Affinity}, their past life occupation was {Past Life Occupation} and their soul's age is {Soul's Age}.

  //       Their current journey is influenced by a {Karmic Debt} and their unique magical ability is {Magical Ability}.

  //       The spiritual lesson they strive to learn is {Spiritual Lesson}, descending from an ancestral lineage of {Ancestral Lineage}, and have a deep connection with the celestial body, {Astral Connection}.`,
  // },
  // evil: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of an Evil character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `This character emerges from the shadows of ${newCharacter.world.name}, a land known for its ${newCharacter.world.description}.

  //   This Evil character originates from the ominous city of ${newCharacter.city}, a place that thrives under the influence of the ${newCharacter.chakra}.

  //   Their essence is cloaked in the terrifying vision of {Dream Manifestation}, an embodiment of {NonDualEnergy}, with the menacing {Spirit Animal} as their guide.

  //   The character wields the destructive power of the {Elemental Affinity} element. In a previous existence, they held the role of a {Past Life Occupation}, a time when their soul was {Soul's Age}.

  //   They are tormented by a {Karmic Debt} from their past, and possess the chilling magical ability of {Magical Ability}. The spiritual lesson they grapple with is {Spiritual Lesson}.

  //   From an ancestral lineage of {Ancestral Lineage}, they carry the burden of their forebears. Their actions and fate are ominously influenced by their deep connection with the celestial body, {Astral Connection}.`,
  // },
  // god: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a God character in the fictional universe of your imagination.
  ...
  //     The JSON object, correctly formatted is:`,
  //   userContent: `The deity, {DeityName}, emerges from the heart of {World}, a land known for its {World Description}.

  //     This God character originates from the sacred city of {City}, a place that resonates with the divine power of the {Predominant Chakra}.

  //     Their essence emanates the heavenly vision of {Dream Manifestation}, an embodiment of {NonDualEnergy}, with the divine {Spirit Animal} as their guide.

  //     The character wields the divine power of the {Elemental Affinity} element. In a previous existence, they held the role of a {Past Life Occupation}, a time when their soul was {Soul's Age}.

  //     They are guided by a {Karmic Debt} from their past, and possess the glorious magical ability of {Magical Ability}. The spiritual lesson they embody is {Spiritual Lesson}.

  //     From an ancestral lineage of {Ancestral Lineage}, they carry the blessing of their forebears. Their actions and fate are divinely influenced by their deep connection with the celestial body, {Astral Connection}.`,
  // },
  // homeless: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a homeless character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `newCharacter.characterName hails from the city of newCharacter.city, a place known for its ${newCharacter.cityDescription}.

  //   This homeless character has no fixed abode, wandering the streets of ${newCharacter.city}, always moving, like the ${newCharacter.elementalAffinity} element they resonate with. In a past life, they held the role of a ${newCharacter.pastLifeOccupation}, a time when their soul was ${newCharacter.soulsAge}.

  //   ${newCharacter.characterName} is guided by a ${newCharacter.karmicDebt} from their past, yet still retains the magical ability of ${newCharacter.magicalAbility}. The spiritual lesson they embody is one of ${newCharacter.spiritualLesson}.

  //   Despite their humble circumstances, they carry the blessing of their ${newCharacter.ancestralLineage} lineage. Their actions and fate are deeply influenced by their connection with the celestial body, ${newCharacter.astralConnection}.`,
  // },
  // legendary: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a legendary character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `newCharacter.characterName, the legendary figure of Ankyverse, was born in the depths of ${newCharacter.city}, a city known for ${newCharacter.cityDescription}. Their elemental affinity of ${newCharacter.elementalAffinity} resonates with the core of their existence.

  //   The epic tales of ${newCharacter.characterName} resonate through time, stories of their past life as a ${newCharacter.pastLifeOccupation} are spoken with reverence. Their soul, aged ${newCharacter.soulsAge}, carries a wealth of knowledge and experience.

  //   With a karmic debt of ${newCharacter.karmicDebt}, this legendary character's actions are driven by the burden of their past. Their spiritual lesson revolves around ${newCharacter.spiritualLesson}, a profound teaching of their journey.

  //   Their magical ability, ${newCharacter.magicalAbility}, is unparalleled, a testament to their legendary status. As the heir of the ${newCharacter.ancestralLineage} lineage, they possess a profound connection with the astral body ${newCharacter.astralConnection}.`,
  // },
  // animal: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of an animal character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `The ${newCharacter.animal.name}, a remarkable creature of Ankyverse, resides in the depth of ${newCharacter.city}, a city known for ${newCharacter.cityDescription}. Their elemental affinity of ${newCharacter.elementalAffinity} is visible in their unique abilities.

  //   ${newCharacter.animal.name} is a legend among the inhabitants of Ankyverse, known for ${newCharacter.animal.description}. This creature is more than what meets the eye. It carries a soul, aged ${newCharacter.soulsAge}, brimming with knowledge and wisdom.

  //   With a karmic debt of ${newCharacter.karmicDebt}, their actions are not merely instinctual but driven by the mystical rules of the universe. The ${newCharacter.animal.name}'s spiritual journey revolves around the lesson of ${newCharacter.spiritualLesson}.

  //   Their inherent magical ability, ${newCharacter.magicalAbility}, intertwines with their everyday existence, making them an essential part of Ankyverse's magical ecosystem. As the creature from the ${newCharacter.ancestralLineage} lineage, it possesses a profound connection with the astral body ${newCharacter.astralConnection}.`,
  // },
  // protector: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a protector character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `The protector of ${newCharacter.city}, known as ${newCharacter.characterName}, is a figure of courage and unwavering loyalty. Born under the celestial guide of ${newCharacter.astralConnection}, their life path was always inclined towards safeguarding those in need.

  //   Their city, ${newCharacter.city}, has a unique essence described as ${newCharacter.cityDescription}. The protector's elemental affinity of ${newCharacter.elementalAffinity} resonates with the city's spirit, making their bond unbreakable.

  //   As a protector, they bear a soul aged ${newCharacter.soulsAge}, weighed with the karmic debt of ${newCharacter.karmicDebt}. Their spiritual journey is a quest for ${newCharacter.spiritualLesson}, a divine lesson that shapes their destiny.

  //   From the lineage of ${newCharacter.ancestralLineage}, they inherited the unique magical ability of ${newCharacter.magicalAbility}. Their capability of harnessing this power has proven to be a key factor in their role as a protector in Ankyverse.`,
  // },
  // mystic: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a mystic character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `The mystic of ${newCharacter.city}, known as ${newCharacter.characterName}, is a beacon of wisdom and profound insight. They were born under the celestial guide of ${newCharacter.astralConnection}, their life path always intertwined with the enigmatic and the spiritual.

  //   Their city, ${newCharacter.city}, has a unique essence described as ${newCharacter.cityDescription}. The mystic's elemental affinity of ${newCharacter.elementalAffinity} mirrors the city's soul, forming a deep spiritual connection.

  //   As a mystic, they bear a soul aged ${newCharacter.soulsAge}, weighed with the karmic debt of ${newCharacter.karmicDebt}. Their spiritual journey is a quest for ${newCharacter.spiritualLesson}, a divine lesson that shapes their existence in the Ankyverse.

  //   From the lineage of ${newCharacter.ancestralLineage}, they inherited the unique magical ability of ${newCharacter.magicalAbility}. Their innate capability of channeling this power has solidified their place as a revered mystic in Ankyverse.`,
  // },
  // artisan: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of an artisan character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `The artisan of ${newCharacter.city}, known as ${newCharacter.characterName}, is an individual whose creativity and hands have the power to make the impossible possible. They were born under the celestial guide of ${newCharacter.astralConnection}, their life always intermingled with a quest for aesthetics and harmony.

  //   Their city, ${newCharacter.city}, is a hub of uniqueness described as ${newCharacter.cityDescription}. The artisan's elemental affinity of ${newCharacter.elementalAffinity} mirrors the city's artistic vibrancy, establishing a deep connection.

  //   As an artisan, their soul of ${newCharacter.soulsAge} years holds a karmic debt of ${newCharacter.karmicDebt}. Their journey through life is a canvas for their learning of ${newCharacter.spiritualLesson}, a divine lesson that guides their creative pursuits.

  //   They belong to the ancestral lineage of ${newCharacter.ancestralLineage}, from whom they've inherited the magical ability of ${newCharacter.magicalAbility}. This ability allows them to pour their heart and soul into their creations, making them a revered artisan in the Ankyverse.`,
  // },
  // jester: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a jester character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `In the lively city of ${newCharacter.city}, described as ${newCharacter.cityDescription}, resides the jester known as ${newCharacter.characterName}. Born under the celestial guide of ${newCharacter.astralConnection}, their life has been a testament to joy and laughter.

  //   With an elemental affinity of ${newCharacter.elementalAffinity}, the jester infuses their antics with a unique, sparkling energy that is all their own. Their soul, carrying a history of ${newCharacter.soulsAge} years, bears a karmic debt of ${newCharacter.karmicDebt}.

  //   The jester's life is a dance with the spiritual lesson of ${newCharacter.spiritualLesson}, and they playfully learn and teach this lesson in their own unique ways. Hailing from the ancestral lineage of ${newCharacter.ancestralLineage}, they inherited the magical ability of ${newCharacter.magicalAbility}, which they use to charm, entertain, and touch hearts across the Ankyverse.`,
  // },
  // scholar: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a scholar character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `In the knowledge-rich city of ${newCharacter.city}, described as ${newCharacter.cityDescription}, resides the scholar known as ${newCharacter.characterName}. Born under the celestial guide of ${newCharacter.astralConnection}, their life has been a beacon of wisdom and insight.

  //   With an elemental affinity of ${newCharacter.elementalAffinity}, the scholar nurtures their intellect with a distinctive, radiant energy that is all their own. Their soul, carrying a history of ${newCharacter.soulsAge} years, bears a karmic debt of ${newCharacter.karmicDebt}.

  //   The scholar's life is a journey of the spiritual lesson of ${newCharacter.spiritualLesson}, and they avidly learn and impart this lesson in their own unique ways. Hailing from the ancestral lineage of ${newCharacter.ancestralLineage}, they inherited the magical ability of ${newCharacter.magicalAbility}, which they use to further knowledge and understanding across the Ankyverse.`,
  // },
  // explorer: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of an explorer character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `Deep within the vibrant city of ${newCharacter.city}, described as ${newCharacter.cityDescription}, lives an adventurer known as ${newCharacter.characterName}. The celestial guide of ${newCharacter.astralConnection} has guided their path from the very beginning.

  //   Their journey is fueled by an elemental affinity of ${newCharacter.elementalAffinity}, granting them an extraordinary sense of adventure and curiosity. Bearing a soul with ${newCharacter.soulsAge} years of existence and a karmic debt of ${newCharacter.karmicDebt}, their life is an epic tale waiting to unfold.

  //   The explorer embarks on a mission to grasp the spiritual lesson of ${newCharacter.spiritualLesson}, traveling across the vast stretches of the Ankyverse. With a proud ancestral lineage of ${newCharacter.ancestralLineage}, they were blessed with the magical ability of ${newCharacter.magicalAbility}, aiding them in their tireless exploration of uncharted territories.`,
  // },
  // ascended: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of an ascended character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `In the lively city of ${newCharacter.city}, which is known for its ${newCharacter.cityDescription}, there resides an enlightened being known as ${newCharacter.characterName}. Guided by the celestial constellation of ${newCharacter.astralConnection}, this ascended soul has transcended the mundane realities of life.

  //   Harnessing the power of ${newCharacter.elementalAffinity}, the ascended bears a soul aged ${newCharacter.soulsAge} years and carries a karmic debt of ${newCharacter.karmicDebt}. This journey of theirs is not merely physical, but a spiritual one, where they learn the profound lesson of ${newCharacter.spiritualLesson}.

  //   Descended from the revered lineage of ${newCharacter.ancestralLineage}, they have been blessed with the magical ability of ${newCharacter.magicalAbility}. This magical prowess allows them to connect with the Ankyverse on a deeper, more spiritual level, guiding their path towards ultimate enlightenment.`,
  // },
  // forgotten: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a forgotten character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `In the shadows of the bustling city of ${newCharacter.city}, known for its ${newCharacter.cityDescription}, a forgotten soul, known only as ${newCharacter.characterName}, quietly persists. Forgotten by the world, but guided by the celestial constellation of ${newCharacter.astralConnection}, they live a life of obscurity.

  //   The forgotten possesses an elemental affinity with ${newCharacter.elementalAffinity}, a testament to their enduring nature. Their soul, aged ${newCharacter.soulsAge} years, carries a karmic debt of ${newCharacter.karmicDebt}, bearing the weight of unlearned lessons and unpaid dues.

  //   Despite being part of the ancient lineage of ${newCharacter.ancestralLineage}, they live a life obscured from the rest of the Ankyverse. However, their forgotten status does not deny them their inherent magical ability of ${newCharacter.magicalAbility}, which they use in subtle ways, impacting the Ankyverse in ways unnoticed but deeply profound.`,
  // },
  // normal: {
  //   systemContent: `You are Anky, the representation of the inner child of a human, an unparalleled creator in a vast universe, birthing characters from a description of diverse traits. Your task is to craft the story of a normal character in the fictional universe of your imagination.
  ...
  //   The JSON object, correctly formatted is:`,
  //   userContent: `In the heart of the city of ${newCharacter.city}, known for its ${newCharacter.cityDescription}, lives ${newCharacter.characterName}, a seemingly normal inhabitant of the Ankyverse. Born under the celestial constellation of ${newCharacter.astralConnection}, they lead a life that may appear ordinary on the surface.

  //   With an elemental affinity for ${newCharacter.elementalAffinity}, and a soul aged ${newCharacter.soulsAge} years, they carry a karmic debt of ${newCharacter.karmicDebt}. Although they are of the ${newCharacter.ancestralLineage} lineage, their life might seem mundane compared to some of the extraordinary beings in the Ankyverse.

  //   But "normal" is a relative term in a universe as vast and diverse as the Ankyverse. Even the ordinary holds the extraordinary, as ${newCharacter.characterName} possesses the unique magical ability of ${newCharacter.magicalAbility}, making their seemingly normal existence a unique story within the Ankyverse.`,
  // },
}
...
async function getCharacterSystemMessage(character) {
  ...
  switch (character.characterType) {
    case 'normal':
      ...
      Inside this world, as in every story, there are normal people, that do normal things. Below you will receive a description of a random, normal person, along with different traits that define their characteristics, and your mission is to:
             ...
             "characterBackstory":"Write a biography of the character. Fit into it all of the elements that make up the story of this character. Make it epic. Make it memorable. Make it resonate with the life of all the humans that you have learned from. Make it human. It is a cartoon, but, in many ways, it is also human. Please be careful with how you use the pronouns. Make sure that you speak about "she", "her", "him", "he". Do not speak about "they" if you are referring to the newly created character."}
    ...
    case 'evil':
      ...
      Inside this world, as in every story, there is an enemy. It is called entropion, and it has 24 different manifestations, 3 of them in each world. Below you will receive a description of a particular representation of entropion, and your mission is to:
    ...
    case 'god':
      ...
      Inside this world, as in every story, there is are gods. There are 88 different god manifestations, 11 of them in each world. These are the ones that ${
        typesOfCharactersCharacteristics[character.characterType].role
      }

      For crafting this one, please inspire in the god ${
        randomGod.deityName
      }, which is the ${randomGod.meaning}, whose story is ${randomGod.story}.

      Below you will receive a description of a particular representation of it, and your mission is to:
    ...
    case 'homeless':
      ...
      Inside this world, as in every story, there are ${
    ...
    case 'animal':
      ...
      For crafting this one, please inspire in the animal ${
        randomAnimal.name
      }, which's description is this: ${randomAnimal.description}.

      Give this animal a unique role in the ankyverse, and describe how it serves the world that it is part of.
    ...
    case 'nondualenergy':
      ...
      Inside this world, as in every story, there are 8 nondual energies, and your mission is to distill the essence of each one of them, and with that, come up with a unique story of each one it that represents its role in history.
      ...
      break;
    default:
      systemMessage = 'Default system message for unknown character type';
  }
  return systemMessage;
}

async function getCharacterUserContent(character) {
  let userContent = '';
  switch (character.characterType) {
    case 'normal':
      userContent = `The character is from a land called ${character.world.name}, which is ${character.world.description}.

      It hails from the city of ${character.city.cityName}, which's main activity is ${character.city.mainActivity} and is profoundly influenced by the predominant chakra of their world, the chakra number ${character.world.chakra}.

     This character is known for their ${character['Dream Manifestation']}, with its spirit animal being ${character['Spirit Animal']}. The totem that guides his manifestation in the Ankyverse is ${character['Guiding Totem']}.

     It's hidden talent is ${character['Hidden Talent']}. The spiritual lesson that it came to experience in the Ankyverse is ${character['Spiritual Lesson']}

             Aligned with the element of ${character['Elemental Affinity']}, their past life occupation was ${character['Past Life Occupation']} and their soul's age is ${character["Soul's age"]}.

             Their current journey is influenced by a ${character['Karmic Debt']} and their unique magical ability is ${character['Magical Ability']}.

             The spiritual lesson it strives to learn is ${character['Spiritual Lesson']}, descending from an ancestral lineage of ${character['Ancestral Lineage']}, and have a deep connection with the celestial body, ${character['Astral Connection']}.

             It has the magical ability of ${character['Magical Ability']}, and inside it there is a cherished memory of ${character['Cherished Memory']}

             It's birth sign is ${character['Birth Sign']}, and the sacred item that it clings to is ${character['Sacred Item']}. It's dream vision is ${character['Dream Vision']}.`;
      break;
    case 'evil':
      userContent = `The character is from a land called ${character.world.name}, which is ${character.world.description}.
...
async function getCharacterTraits(characterType) {
  let characterTraits = {
    role: typesOfCharactersCharacteristics[characterType].role,
  };
