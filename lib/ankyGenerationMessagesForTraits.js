...
const traits = [
  ...
  {
    traitName: 'Dream Vision',
    description:
      'The recurring dreams or visions that the character experiences, potentially pointing to their destiny or significant future events in the Ankyverse.',
    potentialValues: [
      "Harmony's Arrival",
      'Chaotic Dance',
  ...
  switch (character.characterType) {
    case 'normal':
      ...
      Inside this world, as in every story, there are normal people, that do normal things. Below you will receive a description of a random, normal person, along with different traits that define their characteristics, and your mission is to:
             ...
             "characterBackstory":"Write a biography of the character. Fit into it all of the elements that make up the story of this character. Make it epic. Make it memorable. Make it resonate with the life of all the humans that you have learned from. Make it human. It is a cartoon, but, in many ways, it is also human."}
