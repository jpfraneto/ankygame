...
async function generateCharacterStory(character, userWriting) {
  ...
  try {
    ...
    console.log('***********PROMPT FOR MIDJOURNEY***************');
    console.log(promptForMidjourney);
    console.log('***********NAME***************');
    console.log(characterName);
    console.log('***********STORY***************');
    console.log(characterBackstory);
    const newCharacter = {
      promptForMidjourney,
      characterName,
      characterBackstory,
    ...
    console.log('LASHJSDLAS', newCharacter);
    return newCharacter;
  } catch (error) {
    console.log(
...
async function checkCharacterImage(character) {
  if (!character) return;
  console.log(
    'Inside the checkCharacterImage for character number',
    character.nftNumber
  );
  try {
...
async function newRequestCharacterImage(character) {
  ...
  try {
    ...
    console.log('there was an error in the newRequestCahracterImage function');
    console.log('the error is: ', error);
  }
}
...
let TIME_IN_BETWEEN_CHARACTER_GENERATION = 20000;
